  ...
  const [submissions, setSubmissions] = useState([
    {
      ...
      message: t("The feast last year was truly spiritual. I felt closer to St. Michael than ever before.", "கடந்த ஆண்டு பெருவிழா உண்மையிலேயே ஆன்மீக ரீதியாக இருந்தது. முன்னெப்போதையும் விட இப்போது புனித மிக்கேலுக்கு நெருக்கமாக இருப்பதை உணர்ந்தேன்."),
      photo: null, // Will use a placeholder if null
                ...
                >
                  <div className="entry-content-wrapper">
                    <div className="entry-photo-side">
                      {sub.photo ? (
                        <img src={sub.photo} alt={sub.name} className="user-photo-circle" />
                      ) : (
